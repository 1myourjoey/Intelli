package com.sky._sb0416.problem;

import com.sky._sb0416.repostory.AnswerRepository;
import com.sky._sb0416.repostory.QuestionRepository;
...
//        model.addAttribute("questions", list);
    ...
    public String submit(@ModelAttribute("ansData") Answer ans) {
        log.info("응답자료 {}", ans);
        com.sky._sb0416.entity.Answer entity = com.sky._sb0416.entity.Answer.toEntity(ans);
